"""Basic L2-L6 orchestration facade for the higher SCAFAD layers."""
...
from core.layer1_pipeline import (
    Layer1AuditRecord,
    Layer1ProcessedRecord,
    Layer1QualityReport,
)
from core.layer2_detection_matrix import Layer2DetectionResult, MultiVectorDetectionMatrix
from core.layer3_trust_fusion import Layer3FusionResult, TrustWeightedFusionEngine
from core.layer4_explainability import ExplainabilityDecisionEngine, Layer4DecisionTrace
from core.layer5_threat_alignment import ThreatAlignmentEngine, ThreatAlignmentResult
from core.layer6_feedback_learning import FeedbackLearningEngine, Layer6FeedbackState


@dataclass
class MultilayerPipelineResult:
    """End-to-end higher-layer result."""
...
class SCAFADMultilayerPipeline:
    """A minimal pipeline that makes Layers 2-6 concrete and testable."""
